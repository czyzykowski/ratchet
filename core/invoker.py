...
class InvocationResult:
    ...
    trace_id: UUID  # execution_id (lookup key for store.get_trace)
...
class ClaudeCodeInvoker:
    ...
    def invoke(self, context: ExecutionContext) -> InvocationResult:
        ...
        3. Save full output (stdout + stderr) to store via store.save_trace()
        ...
        # Build trace content with header (same format as legacy file-based traces)
        header = (
