...
class PostgresStore:
    ...
    def save_trace(self, trace: ExecutionTrace) -> None:
        ...
        Uses a synchronous psycopg connection because this method is called from
        ClaudeCodeInvoker.invoke() which runs in a thread outside the event loop.
        """
        import psycopg  # sync psycopg

        from core.events import EXECUTION_TRACE_RECORDED
