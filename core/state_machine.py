...
VALID_TRANSITIONS: dict[str, set[str]] = {
    ...
    ev.SPEC_QA: {ev.READY_FOR_IMPLEMENTATION, ev.BLOCKED},
    ev.READY_FOR_IMPLEMENTATION: {ev.IN_PROGRESS, ev.BLOCKED},
    ev.IN_PROGRESS: {ev.BLOCKED, ev.READY_FOR_QA},
    ev.READY_FOR_QA: {ev.READY_FOR_DEPLOYMENT, ev.BLOCKED},
    ev.READY_FOR_DEPLOYMENT: {ev.DEPLOYED, ev.BLOCKED},
