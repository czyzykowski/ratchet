...
VALID_TRANSITIONS: dict[str, set[str]] = {
    ev.READY_FOR_SPEC: {ev.SPEC_QA, ev.ABANDONED},
    ev.SPEC_QA: {ev.READY_FOR_IMPLEMENTATION, ev.BLOCKED, ev.READY_FOR_SPEC, ev.ABANDONED},
    ev.READY_FOR_IMPLEMENTATION: {ev.IN_PROGRESS, ev.BLOCKED, ev.READY_FOR_SPEC, ev.ABANDONED},
    ev.IN_PROGRESS: {
        ev.BLOCKED, ev.READY_FOR_QA, ev.READY_FOR_SPEC, ev.ABANDONED,
        ev.WAITING_FOR_INPUT, ev.READY_FOR_IMPLEMENTATION
    },
    ...
    ev.BLOCKED: {ev.READY_FOR_SPEC, ev.SPEC_QA, ev.READY_FOR_IMPLEMENTATION, ev.ABANDONED},
    ev.DEPLOYED: {ev.ABANDONED},
    ev.ABANDONED: set(),
}
...
class TaskStateMachine:
    ...
    async def transition(
        ...
        extra_payload: optional additional fields merged into the event payload.
        """
